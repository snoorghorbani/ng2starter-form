...
var AddFormEffects = /** @class */ (function () {
    function AddFormEffects(actions$, router, service) {
        ...
        this.AddForm$ = this.actions$
            ...
            .map(function (data) { return new add_form_actions_1.AddFormStartAction(data); });
        this.AddFormStart$ = this.actions$
            .ofType(add_form_actions_1.AddFormActionTypes.ADD_FORM_START)
            .map(effects_1.toPayload)
            .switchMap(function (data) { return _this.service.add(data); })
            .map(function (res) { return new add_form_actions_1.AddFormSucceedAction(); })
            .catch(function () { return Observable_1.Observable.of(new add_form_actions_1.AddFormFailedAction()); });
    }
