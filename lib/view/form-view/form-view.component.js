...
var FormViewComponent = /** @class */ (function () {
    function FormViewComponent(service, compiler, resolver, store) {
        ...
        this.schema$.subscribe(function (schema) {
            ...
            setTimeout(function () {
                ...
                var _module = _this.createModuleWithFormComponent(schema, _this.template, _this.formGroup);
    ...
    FormViewComponent.prototype.createModuleWithFormComponent = function (schema, template, formGroup) {
        var CustomComponent = /** @class */ (function () {
            function CustomComponent() {
                this.accept = new events_1.EventEmitter();
                this.cancel = new events_1.EventEmitter();
